...
export default () => (
  <>
    <h2 style={{ textAlign: "center" }}>
      <strong>POLÍTICA DE PRIVACIDAD BCP NOTIFY</strong>
    </h2>
    <p>&nbsp;</p>
    <p>
      El presente Política de Privacidad establece los términos en que BCP
      NOTIFY usa y protege la información que es proporcionada por sus usuarios
    ...
    <p>
      BCP NOTIFY está altamente comprometido para cumplir con el compromiso de
    ...
    <p>
      ...
      al tráfico web, y también facilita las futuras recurrente. Otra función
      que tienen las cookies es que con ellas las web pueden reconocerte
      individualmente y por tanto brindarte el mejor servicio personalizado de
      su web.
    </p>
    <p>
    ...
    <p>
      BCP NOTIFY Se reserva el derecho de cambiar los términos de la presente
